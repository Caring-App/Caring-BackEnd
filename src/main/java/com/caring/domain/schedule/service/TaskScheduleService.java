...
public class TaskScheduleService {
    ...
    @Transactional
    public TaskScheduleResponseDto createTask(Long wardId, TaskScheduleRequestDto requestDto) {
    ...
    public List<TaskScheduleResponseDto> getTasksByDate(Long wardId, LocalDate date) {
    ...
    @Transactional
    public TaskScheduleResponseDto updateTask(Long taskId, TaskScheduleRequestDto requestDto) {
    ...
    public void deleteTask(Long taskId) {
        if (!taskScheduleRepository.existsById(taskId)) {
            throw new IllegalArgumentException("해당 일정이 존재하지 않습니다. ID = " + taskId);
        }
        taskScheduleRepository.deleteById(taskId);
    }
}